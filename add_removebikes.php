...
<html lang="en">
 ...
 ?>
  <h3 class= "text-center my-4" style="color: #FFFFFF;">Add Bike information</h3>
  ...
  <div class="form-group col-md-6">
    <label for="exampleFormControlTextarea1"style="color: #FFFFFF;">Bike Description</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description"></textarea>
  </div>
  <div class="form-group col-md-6">
  <input type="hidden" name="size" value="1000000" class="form-control">
  <div class="form-group col-md-6">
  <label for="exampleFormControlTextarea1"style="color: #FFFFFF;">Bike Photo</label>
...
<h3 class= "text-center my-4"style="color: #FFFFFF;" >Available Bike details</h3>
<div class="container my-4">
    ...
    <table class="table" id="myTable">
      <thead>
        <tr>
          <th scope="col"style="color: #FFFFFF;">Bike Photo</th>
          <th scope="col"style="color: blue;">Bike Name</th>
          <th scope="col"style="color: blue;">Company</th>
          <th scope="col"style="color: blue;">Type</th>
          <th scope="col"style="color: blue;">Bike Number</th>
          <th scope="col"style="color: #FFFFFF;">Availability</th>
